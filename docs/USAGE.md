...
## Подключение видеорегистратора (NVR / XMEye / DVRIP, порт 34567)

Если ваши камеры подключены к китайскому видеорегистратору (модели на
прошивке Xiongmai — большинство «бюджетных» NVR, работающих с XMEye
PC/мобильным), достаточно ввести **один** адрес — приложение само найдёт
